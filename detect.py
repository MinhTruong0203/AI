...
def Segment():
    imgdir = cv2.imread(r'C:\Users\Admin\Downloads\AI cuoi ky\AI123\Temp\scan.jpg',0)
    model = load_model(r'C:\Users\Admin\Downloads\AI cuoi ky\AI123\weights\line.h5')
    img= imgdir
    img= imgdir
    ...
    plt.imsave(r'C:\Users\Admin\Downloads\AI cuoi ky\AI123\Temp\test_img_mask.JPG',pred)
    coordinates=[]
    img = cv2.imread(r'C:\Users\Admin\Downloads\AI cuoi ky\AI123\Temp\test_img_mask.JPG',0) 
